...
<?php 
	...
	{
		$kodehotel = $_POST['hotelkode'];
		$namahotel = $_POST['hotelnama'];
		...
		if(($ekstensifile == "jpg") or ($ekstensifile == "JPG"))
		{
			...
			mysqli_query($connection, "insert into hotel value ('$kodehotel', '$namahotel', '$namafile')");
		}
...
<div class="col-sm-10">
	<form method="POST" enctype="multipart/form-data">
		<div class="mb-3 row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="kodehotel" name="hotelkode" placeholder="Input kode hotel" maxlength="4">
			</div>
		</div>
		...
		<div class="mb-3 row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="namahotel" name="hotelnama" placeholder="Input nama hotel">
			</div>
		</div>
...
<div class="row">
	...
	<div class="col-sm-10">
		<div class="jumbotron jumbotron-fluid">
			<div class="container">
				<h1 class="display-4">Daftar Hotel Destinasi Wisata</h1>
			</div>
		</div>
	...
	<table class="table table-dark table-striped">
		...
		<tbody>
			...
			{
  				$search = $_POST["search"];
  				$query = mysqli_query($connection, "select * from hotel where hotelKODE like '%".$search."%' limit $mulaitampilan, $jumlahtampilan");
  			} else
  				{
  					$query = mysqli_query($connection,"select * from hotel limit $mulaitampilan, $jumlahtampilan");
  				}
			$nomor = 1;
