        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Daftar Destinasi Wisata Travel</h1>
<?php
...
<div class="col-sm-10">
    ...
    <table class="table table-dark table-striped">
        ...
        <tbody>
            ...
            {
                $search = $_POST["search"];
                $query = mysqli_query($connection, "select * from travel, kategoriwisata where travel.kategoriKODE = kategoriwisata.kategoriKODE and travelKODE like '%".$search."%' limit $mulaitampilan, $jumlahtampilan");
            } else
                {
                    $query = mysqli_query($connection,"select * from travel, kategoriwisata where travel.kategoriKODE = kategoriwisata.kategoriKODE limit $mulaitampilan, $jumlahtampilan");
                }
            $nomor = 1;
