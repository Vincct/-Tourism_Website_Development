...
<?php
    ...
    $ekstensifile = pathinfo($namafile, PATHINFO_EXTENSION);
		...
		if(($ekstensifile == "jpg") or ($ekstensifile == "JPG"))
		{
			...
			mysqli_query($connection, "update destinasi set destinasiNAMA='$destinasiNAMA', destinasiKET='$destinasiKET', destinasiFOTO='$namafile', kategoriKODE='$kategoriKODE' where destinasiKODE='$destinasiKODE'");
		}
...
<div class="row">
	...
	<div class="col-sm-10">
    	...
    	<div class="col-sm-10">
      		<input type="text" class="form-control" name="kodedestinasi" id="destinasiKODE" value="<?php echo $rowedit["destinasiKODE"] ?>" readonly>
    	</div>
	</div>
	<div class="mb-3 row">
    	<label for="destinasiNAMA" class="col-sm-2 col-form-label">Nama Destinasi</label>
    	<div class="col-sm-10">
      		<input type="text" class="form-control" name="namadestinasi" id="destinasiNAMA" value="<?php echo $rowedit["destinasiNAMA"] ?>">
    	</div>
	</div>
	<div class="mb-3 row">
    	<label for="destinasiKET" class="col-sm-2 col-form-label">Keterangan Destinasi</label>
      <div class="col-sm-10">
          <input type="text" class="form-control" name="ketdestinasi" id="destinasiKET" value="<?php echo $rowedit["destinasiKET"] ?>">
      </div>
  </div>
