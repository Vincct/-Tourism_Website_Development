...
<?php
  ...
  if(isset($_POST['edit']))
  {
    ...
    mysqli_query($connection, "update kategoriwisata set kategoriNAMA='$kategoriNAMA', kategoriKET='$kategoriKET', kategoriREFERENCE='$kategoriREFERENCE' where kategoriKODE='$kategoriKODE'");
    //header("location:dashboardkategori.php"); //agar setelah input data maka akan kembali ke location pada header ini
  }
	$inputKategoriKode = $_GET['ubah'];
	$editkategori = mysqli_query($connection, "select * from kategoriwisata where kategoriKODE = '$inputKategoriKode'");
...
<div class="row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="kategorikode" name="inputKategoriKode" placeholder="Inputkan Kode Kategori" value="<?php echo $rowedit["kategoriKODE"] ?>" readonly>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="kategorinama" name="inputKategoriNama" placeholder="Inputkan Nama Kategori" value="<?php echo $rowedit["kategoriNAMA"] ?>">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="kategoriket" name="inputKategoriKet" placeholder="Inputkan Ket Kategori" value="<?php echo $rowedit["kategoriKET"] ?>">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="kategoriref" name="inputKategoriRef" placeholder="Inputkan Referensi Kategori" value="<?php echo $rowedit["kategoriREFERENCE"] ?>">
    </div>
  </div>

    <button type="submit" class="btn btn-secondary" value="edit" name="edit">Simpan</button>
