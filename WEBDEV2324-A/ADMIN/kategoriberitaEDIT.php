    ...
    if(($ekstensifile == "jpg") or ($ekstensifile == "JPG"))
        {
            ...
            mysqli_query($connection, "update berita set kategoriberitaNAMA='$kategoriberitaNAMA', kategoriberitaKET='$kategoriberitaKET', kategoriberitaKAT='$kategoriberitaKAT', kategoriberitaFOTO='$namafile' where kategoriberitaKODE='$kategoriberitaKODE'");
        }
     mysqli_query($connection, "update berita set kategoriberitaNAMA='$kategoriberitaNAMA', kategoriberitaKET='$kategoriberitaKET', kategoriberitaKAT='$kategoriberitaKAT' where kategoriberitaKODE='$kategoriberitaKODE'");
  }

  //Menerima kirim data dari kategoriwisata.php
    $inputKategoriKode = $_GET['Edit'];
    $editberita = mysqli_query($connection, "select * from berita where kategoriberitaKODE = '$inputKategoriKode'");
...
<form method="POST" enctype="multipart/form-data">
  <div class="form-group row">
    ...
    <div class="col-sm-4">
      <input type="text" class="form-control" id="kategoriberitaKODE" name="inputKategoriKode" placeholder="Kode Kategori Berita" maxlength="4" value="<?php echo $rowedit["kategoriberitaKODE"]?>" readonly>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-4">
      <input type="text" class="form-control" id="kategoriberitaNAMA" name="inputKategoriNama" placeholder="Nama Kategori Berita" value="<?php echo $rowedit["kategoriberitaNAMA"]?>">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-4">
      <input type="text" class="form-control" id="kategoriberitaKAT" name="inputKategoriKat" placeholder="Kategori Berita" value="<?php echo $rowedit["kategoriberitaKAT"]?>">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-4">
      <input type="text" class="form-control" id="kategoriberitaKET" name="inputKategoriKet" placeholder="Keterangan Kategori Berita" value="<?php echo $rowedit["kategoriberitaKET"]?>">
    </div>
  </div>
  ...
  <div class="form-group row">
      ...
      <div class="col-sm-10">
          <input type="file" id="file" name="file" value="<?php echo $rowedit["kategoriberitaFOTO"] ?>">
      </div>
  </div>

  <button type="submit" class="btn btn-primary" value="Edit" name="Ubah">Edit</button>
  ...
  <?php
    ...
    if(isset ($_POST["kirim"]))
    {
        ...
        $query = mysqli_query($connection, "select *
            from berita
            where kategoriberitaNAMA like '%".$search."%'");
    } else
        {
