...
<?php 
	...
	if(isset($_POST['Ubah']))
	{
		...
		if(($ekstensifile == "jpg") or ($ekstensifile == "JPG"))
		{
			...
			mysqli_query($connection, "update hotel set hotelNAMA='$namahotel', hotelFILE='$namafile' where hotelKODE='$kodehotel'");
		}
		mysqli_query($connection, "update hotel set hotelNAMA='$namahotel' where hotelKODE='$kodehotel'");
	}
	$hotelkode = $_GET['Edit'];
...
<div class="row">
	...
	<div class="col-sm-10">
    	...
    	<div class="col-sm-10">
      		<input type="text" class="form-control" name="hotelkode" id="kodehotel" placeholder="Input kode hotel" maxlength="4" value="<?php echo $rowedit["hotelKODE"]?>" readonly>
    	</div>
	</div>
	<div class="mb-3 row">
    	<label for="namahotel" class="col-sm-2 col-form-label">Nama Hotel</label>
    	<div class="col-sm-10">
      		<input type="text" class="form-control" name="hotelnama" id="namahotel" placeholder="Input nama hotel" value="<?php echo $rowedit["hotelNAMA"]?>">
    	</div>
  </div>
  <div class="mb-3 row">
