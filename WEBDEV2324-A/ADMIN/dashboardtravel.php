...
<?php 
	...
	if(isset($_POST['Simpan']))
	{
		...
		mysqli_query($connection, "insert into travel value ('$travelkode', '$traveljenis', '$kategorikode')");
	}
...
<div class="col-sm-10">
	<form method="POST" enctype="multipart/form-data">
		<div class="mb-3 row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="travelkode" name="kodetravel" placeholder="Kode Travel" maxlength="4">
			</div>
		</div>
		...
		<div class="mb-3 row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="traveljenis" name="jenistravel" placeholder="Jenis Travel">
			</div>
		</div>
...
<div class="row">
	...
	<table class="table table-dark table-striped">
		...
		<tbody>
			...
			{
  				$search = $_POST["search"];
  				$query = mysqli_query($connection, "select * from travel where travelKODE like '%".$search."%' limit $mulaitampilan, $jumlahtampilan");
  			} else
  				{
  					$query = mysqli_query($connection,"select * from travel limit $mulaitampilan, $jumlahtampilan");
  				}
			$nomor = 1;
