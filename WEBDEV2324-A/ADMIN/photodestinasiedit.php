...
<?php 
	...
	if(isset($_POST['ubahfoto']))
	{
		...
		if(($ekstensifile == "jpg") or ($ekstensifile == "JPG"))
		{
			...
			mysqli_query($connection, "update fotodestinasi set fotodestinasiNAMA='$namafoto', destinasiKODE='$kodedestinasi', fotodestinasiFILE='$namafile' where fotodestinasiKODE='$kodefoto'");
		}
	...
	$inputkode = $_GET['Edit'];
	$editphotodestinasi = mysqli_query($connection, "select * from fotodestinasi where fotodestinasiKODE = '$inputkode'");
	$rowedit = mysqli_fetch_array($editphotodestinasi);

	$editdestinasi = mysqli_query($connection, "select * from fotodestinasi, destinasi where fotodestinasiKODE = '$inputkode' and fotodestinasi.destinasiKODE = destinasi.destinasiKODE");
...
<div class="col-sm-10">
	...
	<form method="POST" enctype="multipart/form-data">
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="submit" name="ubahfoto" class="btn btn-primary" value="Edit">
	...
	<table class="table table-hover table-danger">
		...
		<tbody>
			...
			if(isset($_POST["kirim"])) {
				$search = $_POST["search"];
				$query = mysqli_query($connection, "select * from fotodestinasi where fotodestinasiKODE like '%".$search."%'");
			}else
				{
